              ...
              <div className="page-title-box d-flex align-items-center justify-content-between">
                ...
                <div className="page-title-right">
                  <ol className="breadcrumb m-0">
                    ...
                    <li className="breadcrumb-item active"> Property Approval Manager</li>
                  </ol>
                </div>
              </div>
            </div>
            ...
            <div className='col-md-6'>
              <div className="card">
                <div className="card-header">
                  <h3 className="card-title">Property Approval Manager </h3>
                </div>
...
export default PropertyApprovalManager