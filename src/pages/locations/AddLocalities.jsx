                            ...
                            <div className="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div className="page-title-right">
                                    <ol className="breadcrumb m-0">
                                        ...
                                        <li className="breadcrumb-item active">Add Localities</li>
                                    </ol>
                                </div>
                                <div className="page-title-right">
                                    <Link to='/localities'><button className='btn btn-info'>Localities</button></Link>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <div className="mb-3">
                                            <div className="form-floating">
                                                <input type="text" id="locality-name" className="form-control" name="LocalityName" placeholder="Insert your firstname" required />
