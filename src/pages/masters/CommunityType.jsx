...
const CommunityType = () => {
  ...
  const validate = () => {
    ...
    if (!form.name) {
      isFormValid = false;
      errors.name = 'Please Enter Community Type';
    }
    if (!form.description) {
      isFormValid = false;
  ...
  const handleSubmit = async () => {
    if (validate()) {
      let res;
      if (update?.id) {
        res = await masterClient.put(`communityTypes/${update.id}`, form);
      } else {
        res = await masterClient.post('communityTypes', form);
      }
      try {
        setLoading(true);
        if (res?.data?.status) {
  ...
  const deletcommunity = async (propId) => {
    setLoading(true);
    try {
      const res = await masterClient.delete(`communityTypes/${propId}`);
      if (res?.data?.status) {
        toastSuccess(res?.data?.message);
        getCommunityTypes();
      }
  ...
  //Edit community Type
  const handleEdit = (comunityData) => {
    setShow(true);
    setForm({ ...comunityData });
    setUpdate(comunityData);
  };
          ...
          <div className="container-fluid">
                ...
                <div className="page-title-box d-flex align-items-center justify-content-between">
                  <div className="page-title-right">
                    <ol className="breadcrumb m-0">
                      ...
                      <li className="breadcrumb-item active">Add Community Type</li>
                    </ol>
                  </div>
                  <div className="page-title-right">
              ...
              <div className="col-md-12">
                <div className="card">
                  <div className="card-header">
                    <h3 className="card-title"> Community Types</h3>
                    <div className="">
                      <input
                        type="text"
                            ...
                            <tr key={index}>
                              ...
                              <td className="table-icons">
                                <tr>
                                  ...
                                  <td onClick={() => deletcommunity(item.id)}>
            ...
            <Offcanvas show={show} onHide={() => setShow(false)} placement="end">
              ...
              <Offcanvas.Body>
                <div className="card">
                  <div className="card-header">
                    <h3 className="card-title">Add Community Type</h3>
                  </div>
                  <div className="card-body">
