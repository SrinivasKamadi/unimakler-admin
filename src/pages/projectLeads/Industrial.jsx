...
const Industrial = () => {
  ...
  const getProjects = async () => {
    ...
    try {
      setLoading(true)
      res = await projectClient.get(`/getProjects/${9}/${1}`);
      if (res?.data?.status) {
              ...
              <div className="page-title-box d-flex align-items-center justify-content-between">
                <div className="page-title-right">
                  <ol className="breadcrumb m-0">
                    <li className="breadcrumb-item active"><h4 className="m-0 font-bold">Project Leads - Industrial</h4></li>
                  </ol>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-12">
              <div className="card">
                <div className="card-header">
                  <h3 className="card-title">Industrial Leads Lists</h3>
                </div>
                <div className="card-body">
