                            ...
                            <div className="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div className="page-title-right">
                                    <ol className="breadcrumb m-0">
                                        ...
                                        <li className="breadcrumb-item active">Approved Property Rentals</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='col-md-6'>
                            <div className="card">
                                <div className="card-header">
                                    <h3 className="card-title">Approved Property Rentals</h3>
                                </div>
...
export default ApprovedPropertyRentals