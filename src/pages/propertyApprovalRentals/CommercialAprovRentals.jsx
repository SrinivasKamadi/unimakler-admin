          ...
          <div className="col-12">
            ...
            <div className="page-title-right">
                <ol className="breadcrumb m-0">
                 <li className="breadcrumb-item active"><h4 className="m-0 font-bold">Projects Approvals Rental for Commercial</h4></li>
               </ol>
              </div>
            </div>
          </div>
...
<div className="row justify-content-center ">
        ...
        <div className="row justify-content-center">
            <div className="col-md-12">
              <div className="card">
                <div className="card-header">
                  <h3 className="card-title"><h3 className="card-title">Projects Approvals Rental for Commercial Lists</h3></h3>
                  {/* <div className="mb-3">
                    <input
                      type="text"
...
export default CommercialAprovRentals